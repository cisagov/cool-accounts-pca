...
```hcl
module "example" {
  source = "github.com/cisagov/cool-accounts-pca"
...
* [Deploying into the default VPC](https://github.com/cisagov/cool-accounts-pca/tree/develop/examples/default_vpc)
